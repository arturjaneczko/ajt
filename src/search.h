...
void printSearch() {
	...
	std::cout << "\t" << green("?") << " " << yellow("<key>") << purple(" - key search | ") << purple("[") << " " << blue("?") << " " << purple("] indicator") << "\n";
	std::cout << "\t" << green("?#") << " " << yellow("<tag>") << purple(" - tag search | ") << purple("[") << " " << blue("#") << " " << purple("] indicator") << "\n";
	std::cout << "\t" << green("?.") << " " << yellow("<sequence>") << purple(" - content search | ") << purple("[") << " " << blue(".") << " " << purple("] indicator") << "\n";
	std::cout << "\t" << purple("Type") << " " << blue("ESC") << " " << purple("button to exit search mode.") << "\n";
}
